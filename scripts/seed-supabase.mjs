...
const candidates = [
  {
    ...
    region: "Lima",
    ideology: "derecha",
    bio: "Empresario y politico peruano. Ex alcalde de Lima Metropolitana (renuncio en octubre 2025 para postular a la presidencia). Fundador de Renovacion Popular. Lidera las encuestas para las elecciones 2026.",
    poll_average: 13.3,
    poll_trend: "stable",
  ...
  },
  {
    ...
    region: "Lima",
    ideology: "derecha",
    bio: "Politica peruana e hija del fallecido expresidente Alberto Fujimori (m. septiembre 2024). Cuarta postulacion a la presidencia. Segunda en las encuestas.",
    poll_average: 7.3,
    poll_trend: "stable",
