...
export function CandidateProfileClient({ candidate }: CandidateProfileClientProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Back button */}
      <Link href={`/${country.code}/candidatos`}>
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            {/* Avatar */}
            <div
              className="flex h-24 w-24 flex-shrink-0 items-center justify-center rounded-2xl border-2 overflow-hidden"
              style={{
        ...
        <Card className="bg-card border-primary/20 hover:border-primary/40 transition-all cursor-pointer group overflow-hidden">
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">Radiografía Completa</p>
