...
import { candidates, IDEOLOGY_LABELS, type Ideology } from "@/lib/data/candidates";
...
export default function CandidatosPage() {
  ...
  const filteredCandidates = useMemo(() => {
    ...
    return result;
  }, [searchQuery, selectedIdeology, sortBy]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Buscar por nombre, partido o profesion..."
      ...
      {/* Ideology filter */}
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-xs text-muted-foreground mr-1">Ideologia:</span>
        <Badge
